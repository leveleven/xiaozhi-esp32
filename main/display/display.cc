...
void Display::SetAviEmotionLVGL(const char* avi_path) {
    // 默认实现：对于不支持AVI显示的显示类，忽略调用
    ESP_LOGW(TAG, "SetAviEmotionLVGL not implemented for this display type: %s", avi_path);
}
